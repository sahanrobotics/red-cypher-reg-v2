            ...
            <div className={`footer-nav ${currentStep !== 1 ? 'spread' : 'end'}`}>
              {currentStep !== 1 && (
                <button
                  ...
                  {...backButtonProps}
                  onClick={(e) => {
                    if (backButtonProps.onClick) backButtonProps.onClick(e);
                    if (!e.defaultPrevented) handleBack(e);
                  }}
                >
                  {backButtonText}
                </button>
              ...
              <button 
                ...
                {...nextButtonProps}
                onClick={(e) => {
                  if (nextButtonProps.onClick) nextButtonProps.onClick(e);
                  if (!e.defaultPrevented) {
                    isLastStep ? handleComplete(e) : handleNext(e);
                  }
                }}
              >
    ...
    <motion.div onClick={handleClick} className="step-indicator" style={disableStepIndicators ? { pointerEvents: 'none', opacity: 0.5 } : {}} animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: '#ff3131', color: '#ff3131' },
          complete: { scale: 1, backgroundColor: '#ff3131', color: '#fff' }
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: '#ff3131' }
  };
